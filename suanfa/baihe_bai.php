...
while($row = $dosql->GetArray()){
    ...
    $data[$row['cp_dayid']]['reds']  = explode(',', $row['percent_reds']);
    $data[$row['cp_dayid']]['wins']  = $row['percent_reds_win'];
}
...
<body>
    <div class="layui-container">
        <blockquote class="layui-elem-quote">看彩72变&nbsp;&nbsp;》&nbsp;百分比预测法</blockquote>
        ...
        <div class="layui-row">
            <div class="layui-col-xs12" style="margin-bottom: 10px;">
                ...
                <?php
                    foreach ($baihe['data_percent_reds'] as $red) {
