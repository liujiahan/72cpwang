...
while($row = $dosql->GetArray()){
    ...
    $data[$row['cp_dayid']]['reds']  = explode(',', $row['baihe_reds']);
    $data[$row['cp_dayid']]['wins']  = $row['baihe_win'];
}
...
<body>
    <div class="layui-container">
        <blockquote class="layui-elem-quote">看彩72变&nbsp;&nbsp;》&nbsp;百合（和）红球算法</blockquote>
        ...
        <div class="layui-row">
            <div class="layui-col-xs12" style="margin-bottom: 10px;">
                ...
                <?php
                    foreach ($baihe['merge_data'] as $red) {
