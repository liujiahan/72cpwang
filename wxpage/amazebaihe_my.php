...
<body>
    <div class="layui-container">
        <blockquote class="layui-elem-quote"><a href="index.php">百合算法——我的方案</a></blockquote>
                ...
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <a href="baihe500new.php" target="_blank" class="layui-btn layui-btn-normal" id="newWeer">新建方案</a>
                        </div>
                    </div>
