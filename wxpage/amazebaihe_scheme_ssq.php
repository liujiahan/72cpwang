...
$schemes = $dosql->GetOne("SELECT * FROM `#@__caipiao_baihe_500w` WHERE id='$id'");

$ssqnum = $dosql->GetOne("SELECT count(*) as num FROM `#@__caipiao_baihe_cpdata` WHERE sid='{$id}'");
...
<body>
    <div class="layui-container">
        <blockquote class="layui-elem-quote">百合算法方案——<?php echo $schemes['cp_dayid']."期" ?></blockquote>
                ...
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <button class="layui-btn layui-btn-normal" id="exportData" onclick="window.location='amazebaihe_excel.php?id=<?php echo $id ?>';">导出【<?php echo $ssqnum['num']; ?>】</button>
