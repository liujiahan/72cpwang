...
<head>
    ...
    <title>红球同期走势 - <?php echo $cfg_seotitle; ?></title>
    <link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css">
    <script type="text/javascript" src="bootstrap/js/jquery.min.js"></script>
    <script type="text/javascript" src="bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript">
    function gourl(){
        window.location.href = "?cp_dayid="+$("#cp_dayid").val()+"&itemid="+$("#itemid").val();
    }
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                        ...
                        $sql = "SELECT * FROM `#@__caipiao_history` WHERE cp_dayid IN (".implode(',', $year).") ORDER BY cp_dayid ASC";
                        $dosql->Execute($sql);
                        $itemsData = array();
