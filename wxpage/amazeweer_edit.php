...
$cp_dayid = isset($cp_dayid) ? $cp_dayid : maxDayid();
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                <div class="layui-input-block" style="margin-left: 20px;">
                                    <?php foreach ($allblue_1 as $v) { ?>
                                        <input type="checkbox" name="blue[]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor($bluemiss[$v]); ?>;padding-right:0;'><?php echo $bluemiss[$v]<10 ? $bluemiss[$v].'&nbsp;&nbsp;' : $bluemiss[$v] ?></span>" value="<?php echo $v ?>">
                                    <?php } ?>
                                </div>
                                <div class="layui-input-block" style="margin-left: 20px;">
                            ...
                            <div style="margin-left: 20px; margin-top: 20px;">
                                <div class="layui-form-item" style="">
                                    <div class="layui-input-block" style="margin-left: 0;">
                                        <input type="radio" name="new_blue_type" value="1" title="全排组合">
                                        <input type="radio" name="new_blue_type" value="2" title="随机插入">
                                        <input type="radio" name="new_blue_type" value="3" title="顺序插入">
                                    </div>
                                </div>
                            </div>
                            <div style="margin-left: 20px; margin-top: 20px;">
