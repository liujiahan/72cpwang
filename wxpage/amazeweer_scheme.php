                    ...
                    <div class="layui-tab-content" style="height: 300px;">
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                ...
                                <div class="layui-input-block" style="margin-left: 0;">
                                    <?php foreach ($weercfg as $v) { ?>
                                        <input type="checkbox" name="weer4[<?php echo str_replace('-', '_', $pos) ?>][]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor($weermiss['weer4'][$pos][$v]); ?>;padding-right:0;'><?php echo $weermiss['weer4'][$pos][$v] ?></span>" value="<?php echo $v ?>" <?php echo isset($redweer['weer4']) && in_array($v, $redweer['weer4'][$pos]) ? 'checked' : '' ?>>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php } ?>
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px; margin-left: -10px;">
                                ...
                                <div class="layui-input-block" style="margin-left: 0;">
                                    <?php foreach ($weercfg as $v) { ?>
                                        <input type="checkbox" name="weer5[]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor(8); ?>;padding-right:0;'><?php echo $weermiss['weer5'][$v] ?></span>" value="<?php echo $v ?>" <?php echo isset($redweer['weer5']) && in_array($v, $redweer['weer5']) ? 'checked' : '' ?>>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php } ?>
                        ...
                        <div class="layui-tab-item">
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                ...
                                <div class="layui-input-block" style="margin-left: 0;">
                                    <?php foreach ($weercfg as $v) { ?>
                                        <input type="checkbox" name="weer6[]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor($weermiss['weer6'][$v]); ?>;padding-right:0;'><?php echo $weermiss['weer6'][$v] ?></span>" value="<?php echo $v ?>" <?php echo isset($redweer['weer6']) && in_array($v, $redweer['weer6']) ? 'checked' : '' ?>>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                <div class="layui-input-block" style="margin-left: 20px;">
                                    <?php foreach ($weerCfg7_1 as $v) { ?>
                                        <input type="checkbox" name="weer7[]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor(8); ?>;padding-right:0;'><?php echo $weermiss['weer7'][$v]<10 ? $weermiss['weer7'][$v].'&nbsp;&nbsp;' : $weermiss['weer7'][$v] ?></span>" value="<?php echo $v ?>" <?php echo isset($redweer['weer7']) && in_array($v, $redweer['weer7']) ? 'checked' : '' ?>>
                                    <?php } ?>
                                </div>
                                <div class="layui-input-block" style="margin-left: 20px;">
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                <div class="layui-input-block" style="margin-left: 20px;">
                                    <?php foreach ($weerCfg8_1 as $v) { ?>
                                        <input type="checkbox" name="weer8[]" lay-skin="primary" title="<?php echo $v ?><span style='color:<?php echo WeerColor(8); ?>;padding-right:0;'><?php echo $weermiss['weer8'][$v]<10 ? $weermiss['weer8'][$v].'&nbsp;&nbsp;' : $weermiss['weer8'][$v] ?></span>" value="<?php echo $v ?>" <?php echo isset($redweer['weer8']) && in_array($v, $redweer['weer8']) == $v ? 'checked' : '' ?>>
                                    <?php } ?>
                                </div>
                                <div class="layui-input-block" style="margin-left: 20px;">
                        ...
                        <div class="layui-tab-item">
                            <form id="weer9Form" class="layui-form">
                            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px; margin-bottom: 10px;">
                              <legend>蓝球设置</legend>
                            </fieldset>
                            <?php
                            ...
                            <div class="layui-form-item" style="margin-bottom: 5px;">
                                <div class="layui-input-block" style="margin-left: 20px;">
                                    <?php foreach ($allblue_1 as $v) { ?>
                                        <input type="checkbox" name="blue[]" lay-skin="primary" title="<?php echo $v ?>" value="<?php echo $v ?>" <?php echo in_array($v, $blue_comb['blue']) ? 'checked' : ''; ?>>
                                    <?php } ?>
                                </div>
                                <div class="layui-input-block" style="margin-left: 20px;">
                            ...
                            <div style="margin-left: 20px; margin-top: 20px;">
                                <div class="layui-form-item" style="">
                                    <div class="layui-input-block" style="margin-left: 0;">
                                        <input type="radio" name="blue_comb" value="1" title="随机插入" <?php echo $blue_comb['blue_comb'] == 1 ? 'checked' : ''; ?>>
                                        <input type="radio" name="blue_comb" value="2" title="顺序插入" <?php echo $blue_comb['blue_comb'] == 2 ? 'checked' : ''; ?>>
                                    </div>
                                </div>
                            </div>
                            <div style="margin-left: 20px; margin-top: 20px;">
                            ...
                            <div style="margin-left: 20px; margin-top: 20px;">
                                <a class="layui-btn layui-btn-lg" id="WeerCalcBtn">微尔算法八步过滤</a>
                                <a class="layui-btn layui-btn-lg" data-id="<?php echo $id ?>" id="WeerSaveBtn">保存方案</a>
                                <a class="layui-btn layui-btn-lg" id="myBtn" href="amazeweer_my.php" target="_blank">我的方案</a>
                            </div>
                            </form>
                        </div>
                    </div>
