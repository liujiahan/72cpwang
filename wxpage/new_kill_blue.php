            ...
            <table class="table">
                ...
                <tbody>
                    <?php 
                        ...
                        $sql = "SELECT * FROM `#@__caipiao_newkill_blue` ORDER BY cp_dayid DESC";
...
$dosql->Execute("SELECT * FROM `#@__caipiao_newkill_blue` ORDER BY cp_dayid DESC LIMIT $limit_num");
while($row = $dosql->GetArray()){
