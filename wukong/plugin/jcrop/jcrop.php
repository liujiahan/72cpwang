...
//引入水印文件
require_once(SNRUNNING_DATA.'/watermark/watermark.class.php');


//初始化参数
$imgurl    = isset($imgurl) ? $imgurl : '';
$srcfile   = SNRUNNING_ROOT.'/'.$imgurl;
...
{
	WaterMark($srcfile, SNRUNNING_ROOT.'/'.$cfg_markpicurl, $cfg_markwhere, $cfg_marktext, '黑体', $cfg_marksize, $cfg_markcolor, $cfg_marktype);
}
