...
{
	$gourl  = 'atm_u_list.php';
	header("location:$gourl");
	exit();
}
elseif($_SESSION['adminlevel']=='2')
{
	$gourl  = 'atm_m_list.php';
	header("location:$gourl");
	exit();
}
elseif($_SESSION['adminlevel']=='4')
{
	$gourl  = 'atm_a_repair.php';
	header("location:$gourl");
	exit();
}
elseif($_SESSION['adminlevel']=='6')
{
	$gourl  = 'natm_u_list.php';
	header("location:$gourl");
	exit();
}
elseif($_SESSION['adminlevel']=='7')
{
	$gourl  = 'yyqj_u_list.php';
	header("location:$gourl");
	exit();
}
 ?>
