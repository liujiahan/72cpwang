...
class Page
{
	...
	//ajax分页
	function AjaxPageByWx()
	{
		global $cid, $flag, $keyword, $wxnewsid;
		$pagetxt = '';
		...
		{	
			...
			if($this->page > 1)
			{
				$pagetxt .= '<a href="javascript:;" onclick="PageListByWx(\'1\',\''.$cid.'\',\''.$flag.'\',\''.$keyword.'\',\''.$wxnewsid.'\')">&lt;&lt;</a>';
				$pagetxt .= '<a href="javascript:;" onclick="PageListByWx(\''.$previous.'\',\''.$cid.'\',\''.$flag.'\',\''.$keyword.'\',\''.$wxnewsid.'\')">&lt;</a>';
			}
			else
			{
				$pagetxt .= '<a href="javascript:;">&lt;&lt;</a>';
			...
			if($this->totalpage < 10)
			{
				...
				for($i=1; $i <= $this->totalpage; $i++)
				{
					...
					{
						$pagetxt .= '<a href="javascript:;" onclick="PageListByWx(\''.$i.'\',\''.$cid.'\',\''.$flag.'\',\''.$keyword.'\',\''.$wxnewsid.'\')" class="num">'.$i.'</a>';
					}
				}
			}
			else
			...
			if($this->page < $this->totalpage)
			{
				$pagetxt .= '<a href="javascript:;" onclick="PageListByWx(\''.$next.'\',\''.$cid.'\',\''.$flag.'\',\''.$keyword.'\',\''.$wxnewsid.'\')">&gt;</a>';
				$pagetxt .= '<a href="javascript:;" onclick="PageListByWx(\''.$this->totalpage.'\',\''.$cid.'\',\''.$flag.'\',\''.$keyword.'\',\''.$wxnewsid.'\')">&gt;&gt;</a>';
			}
			else
			{
				$pagetxt .= '<a href="javascript:;">&gt;</a>';
