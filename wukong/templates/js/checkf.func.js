...
function cfm_infolm()
{
	...
	if($("#infoflag").val() == "" && !$("#infoflag").hasClass('empty'))
	{
		alert("请设置内容标签！");
		$("#infoflag").focus();
		return false;
	...
	var chkObjs=null; 
	var obj=document.getElementsByName("online")
