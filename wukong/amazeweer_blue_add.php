...
<form name="form" id="form" method="post" action="amazeweer_blue_save.php">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
			...
			<td width="75%">
				<input type="text" name="bluenum" class="input" style="width: 100px;" value="" />位
			</td>
		</tr>
		<tr>
			<td width="25%" height="40" align="right">随机1个全匹配：</td>
			<td width="75%">
				<input type="checkbox" name="bluematch" class="input" style="width: 20px;" value="1" />开启
			</td>
		</tr>
		<?php for ($i=1; $i <= 8; $i++) { ?>
		<tr>
			...
			<td width="75%">
				蓝号<input type="text" name="blues[<?php echo $i ?>][blue]" class="input" style="width: 40px;" value="" />
				概率<input type="text" name="blues[<?php echo $i ?>][gailv]" class="input" style="width: 40px;" value="" />
			</td>
		</tr>
		<?php } ?>
	</table>
