...
class Page
{
	...
	//获取分页变量
	function GetPage($sql,$pagenum=10,$limitnum=0)
	{
		global $dosql;
	...
	function GetList()
	{
		...
		else
		{
			...
			$pagetxt = '<nav aria-label="Page navigation" class="text-center"><ul class="pagination pagination-lg">';

			//上一页 第一页
			if($this->page > 1)
			{
				$pagetxt .= '<li><a href="'.$nowurl.'page=1" aria-label="第一页"><span aria-hidden="true">&laquo;</span></a></li>';
				$pagetxt .= '<li><a href="'.$nowurl.'page='.$previous.'" aria-label="上一页"><span aria-hidden="true">&lsaquo;</span></a></li>';
			}
			else
			{
				$pagetxt .= '<li><a href="javascript:;" aria-label="已是第一页"><span aria-hidden="true">&laquo;</span></a></li>';
				$pagetxt .= '<li><a href="javascript:;" aria-label="已是第一页"><span aria-hidden="true">&lsaquo;</span></a></li>';
			}
			...
			if($this->totalpage < 10)
			{
				for($i=1; $i <= $this->totalpage; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<li><a href="javascript:;" aria-label=""><span aria-hidden="true">'.$i.'</span></a></li>';
					}
					else
					{
						$pagetxt .= '<li><a href="'.$nowurl.'page='.$i.'" aria-label="第 '.$i.' 页"><span aria-hidden="true">'.$i.'</span></a></li>';
					}
				}
			}
			else
			{
				...
				if($this->page > 4)
				{
					$pagetxt .= '<li><a href="javascript:;" aria-label=""><span aria-hidden="true">...</span></a></li>';
				}
				...
				for($i=$m; $i<=$b; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<li><a href="'.$nowurl.'page='.$i.'" aria-label=""><span aria-hidden="true">'.$i.'</span></a></li>';
					}
					else
					{
						$pagetxt .= '<li><a href="'.$nowurl.'page='.$i.'" aria-label="第 '.$i.' 页"><span aria-hidden="true">'.$i.'</span></a></li>';
			...
			{
				$pagetxt .= '<li><a href="'.$nowurl.'page='.$next.'" aria-label="下一页"><span aria-hidden="true">&rsaquo;</span></a></li>';
				$pagetxt .= '<li><a href="'.$nowurl.'page='.$this->totalpage.'" aria-label="最后一页"><span aria-hidden="true">&raquo;</span></a></li>';
			}
			else
			{
				$pagetxt .= '<li><a href="javascript:;" aria-label="已是最后一页"><span aria-hidden="true">&rsaquo;</span></a></li>';
				$pagetxt .= '<li><a href="javascript:;" aria-label="已是最后一页"><span aria-hidden="true">&raquo;</span></a></li>';
			}
			$pagetxt .= '</ul></nav>';
		}
